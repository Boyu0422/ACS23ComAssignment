...
/* External objects */
extern i64 line; /* Source code line numbers - defined in scanner.c */
extern Token tokenizer(bust_void);
 ...
 * -------------------------------------------------------------
 */
bust_void printScannerError(String fmt, ...);
bust_void displayScanner(BufferReader* ptrBuffer);
bust_long getScannerFilesize(String fname);
